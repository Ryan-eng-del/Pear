...
type LoginServiceClient interface {
	GetCaptcha(ctx context.Context, in *CaptchaReq, opts ...grpc.CallOption) (*CaptchResp, error)
}
...
func (c *loginServiceClient) GetCaptcha(ctx context.Context, in *CaptchaReq, opts ...grpc.CallOption) (*CaptchResp, error) {
	out := new(CaptchResp)
...
type LoginServiceServer interface {
	GetCaptcha(context.Context, *CaptchaReq) (*CaptchResp, error)
...
func (UnimplementedLoginServiceServer) GetCaptcha(context.Context, *CaptchaReq) (*CaptchResp, error) {
...
func _LoginService_GetCaptcha_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServiceServer).GetCaptcha(ctx, req.(*CaptchaReq))
	}
...
var LoginService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/login_service.proto",
}
